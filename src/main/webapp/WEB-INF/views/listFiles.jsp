				...
				<tbody>
					<c:forEach items="${fileList}" var="dataFile"
						...
						<tr>
							...
							<td><a class="btn btn-primary"
								href="${pageContext.request.contextPath}/getBy/${dataFile.id}">
									<span class="glyphicon glyphicon-download"></span> Edit
							</a></td>
							<td><a class="btn btn-primary"
								href="${pageContext.request.contextPath}/delete/${dataFile.id}">
									<span class="glyphicon glyphicon-danger"></span> Delete
							</a></td>
						</tr>
					</c:forEach>
				</tbody>
